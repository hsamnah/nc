<%@ Page Title="" Language="C#" MasterPageFile="~/Venues/minVenue.Master" AutoEventWireup="true" CodeBehind="venuePhotos.aspx.cs" Inherits="nc.Venues.venuePhotos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function chckbxPostBack() {
                    ...
                    <div>
                        <div style="padding: 5px 5px 5px 5px; vertical-align: top;">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:TextBox runat="server" ID="newFolderName" ClientIDMode="Static" BorderStyle="None" Font-Names=" 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" Font-Size="8pt" Height="15px" Width="200px"></asp:TextBox><br />
                                        <asp:CheckBox ID="makePublic" Text="Is Public" runat="server" Font-Names="'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" Font-Size="10pt" ForeColor="#1A242D" />
                                        &emsp;&emsp;&emsp;&emsp;&emsp;</td>
                                    <td style="text-align: right; vertical-align: top;">
                                        <br />
                                        <asp:ImageButton ID="AddDirectory" ClientIDMode="Static" runat="server" ImageUrl="~/imgs/add_folder.png" Width="15px" OnClick="AddDirectory_Click" AlternateText="Add directory" /><br />
                                        <asp:ImageButton ID="DeleteDirectory" ClientIDMode="Static" runat="server" ImageUrl="~/imgs/close.png" Width="15px" OnClick="DeleteDirectory_Click" AlternateText="Delete selected directory" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div style="padding: 2px 2px 2px 2px; border: 1px solid #3a3b40; height: 465px; overflow-y: scroll;">
                            <asp:TreeView ID="DirectoryListing" runat="server" ImageSet="Msdn" NodeIndent="10" Width="150px" EnableClientScript="true" onclick="chckbxPostBack()" ShowCheckBoxes="All" OnSelectedNodeChanged="DirecorySelect_Change" OnTreeNodeCheckChanged="setVisible_Change">
