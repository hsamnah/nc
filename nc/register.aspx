<%@ Page Title="" Language="C#" MasterPageFile="~/root2.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="nc.root.register" %>
            ...
            <td class="mc_cls" rowspan="2">
                <div class="panel2_cls">
                    <table class="formCell2_cls">
                        ...
                        <tr>
                            <td class="formCell_cls">Username:&emsp;<asp:RequiredFieldValidator ControlToValidate="un" ID="unamVal" runat="server" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator>
                                <asp:Label ID="unCheck" runat="server" Font-Names="'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" Font-Size="9pt" ForeColor="White" Visible="false"></asp:Label>
                                <br />
                                <asp:TextBox ID="un" runat="server" Width="300px" OnTextChanged="checkuser_Change" AutoPostBack="True"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Email Address:&emsp;<asp:RequiredFieldValidator ControlToValidate="email" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator>
                                <asp:Label ID="emaillbl" runat="server" Font-Names="'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" Font-Size="9pt" ForeColor="White" Visible="false"></asp:Label><br />
                                <asp:TextBox ID="email" runat="server" Width="300px" AutoPostBack="True" OnTextChanged="email_chk"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Password:<asp:RequiredFieldValidator ID="pr1" runat="server" ControlToValidate="pwd1" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator><br />
                                <asp:TextBox ID="pwd1" CssClass="password_cls" runat="server" Width="300px" TextMode="Password"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Confirm Password:<span id="err" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 9pt; color: #FF0000"></span><asp:RequiredFieldValidator ID="pr2" runat="server" ControlToValidate="pwd2" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator><br />
                                <asp:TextBox ID="pwd2" CssClass="password_cls" runat="server" Width="300px" TextMode="Password"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Security question:&emsp;<asp:RequiredFieldValidator ControlToValidate="sq" ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator><br />
                                <asp:TextBox ID="sq" runat="server" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Answer:&emsp;<asp:RequiredFieldValidator ControlToValidate="sa" ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator><br />
                                <asp:TextBox ID="sa" runat="server" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">Hint:&emsp;<asp:RequiredFieldValidator ControlToValidate="sh" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ForeColor="Red" EnableClientScript="False"></asp:RequiredFieldValidator><br />
                                <asp:TextBox ID="sh" runat="server" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="formCell_cls">
                                <asp:LinkButton ID="User_register" runat="server" Font-Names="'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" Font-Size="12pt" ForeColor="White" OnClick="User_register_Click">Register</asp:LinkButton>&emsp;<asp:Label ID="errMsg" runat="server" Visible="False" Font-Names="'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" ForeColor="Red" Font-Size="9pt"></asp:Label></td>
                        </tr>
