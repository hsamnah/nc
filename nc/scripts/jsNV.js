(function () {
    ...
    window['jsNV']['isCompatible'] = isCompatible;

    function isArray(myArray) {
        return myArray.constructor.toString().indexOf('Array') > 1;
    }
    window['jsNV']['isArray'] = isArray;
    ...
    window['jsNV']['preventDefault'] = preventDefault;
    ...
    window['jsNV']['stopPropagation'] = stopPropagation;
    ...
    window['jsNV']['getEventObject'] = getEventObject;
    ...
    window['jsNV']['addLoadEvent'] = addLoadEvent;
    ...
    window['jsNV']['removeEvent'] = removeEvent;
    ...
    window['jsNV']['getElementsByClassName'] = getElementsByClassName;
    ...
    window['jsNV']['toggleDisplay'] = toggleDisplay;
    ...
    window['jsNV']['insertAfter'] = insertAfter;
    ...
    function domMgmt() {
        ...
        this.removeCurentNode = function (elem) {
            var elem2Remove = (!jsNV.$(elem)) ? elem : jsNV.$(elem);
            if (elem2Remove != null
    ...
    window['jsNV']['domMgmt'] = new domMgmt();
    ...
    window['jsNV']['prependChild'] = prependChild;

    function objPos() {
        this.setObjPos = function (obj, relativeObj) {
            var f = jsNV.DomOopObjects.$(relativeObj);
            var x = 0;
            var y = 0;
            while (f) {
                x += f.offsetLeft;
    ...
    window['jsNV']['getBrowserWindowSize'] = new getBrowserWindowSize();
    ...
    window['jsNV']['getPointerPositionInDocument'] = getPointerPositionInDocument;
    ...
    window['jsNV']['getMyBoundingClientRect'] = getMyBoundingClientRect;
    ...
    window['jsNV']['getKeyPressed'] = getKeyPressed;
    ...
    window['jsNV']['setStyle'] = setStyleById;
    window['jsNV']['setStyleById'] = setStyleById;
    ...
    window['jsNV']['setStylesByClassName'] = setStylesByClassName;
    ...
    window['jsNV']['setStylesByTagName'] = setStylesByTagName;
    ...
    window['jsNV']['getWindowSize'] = getWindowSize;

    // Canvas functions will now follow:
    function degree2rad(degree) {
        return Math.PI * degree / 180;
    };
    window['jsNV']['degree2rad'] = new degree2rad();
    ...
    window['jsNV']['xmlRequest'] = new xmlRequest();
    ...
    function colorSwatch(eventSrc) {
        ...
        this.colorPalette = function (target,selection) {
            ...
            jsNV.Accessor(esrc, 'e', function (x) { return typeof x == 'object'; });
            esrc.sete(t);
            ...
            for (var i = 0; i < Spectrum.length; i++) {
                for (var j = 0; j < Spectrum.length; j++) {
                    ...
                    for (var k = 0; k < Spectrum.length; k++) {
                        ...
                        jsNV.addEvent(ccell, 'mouseover', function (W3CEvent) {
                            var e = event.srcElement;
                            var target = jsNV.$('clrIO');
                            target.value = e.style.backgroundColor;
                            td1.style.backgroundColor = e.style.backgroundColor;
                        })
                        jsNV.addEvent(ccell, 'mouseout', function (W3CEvent) {
                            var target = jsNV.$('clrIO');
                            target.value = '';
                            td1.style.backgroundColor = '';
                        });
                        jsNV.addEvent(ccell, 'click', function (W3CEvent) {
                            var e1 = event.srcElement;
                            jsNV.preventDefault(ccell);
                            jsNV.stopPropagation(ccell);
                            ...
                            if (esrc.gete().nodeName === 'INPUT') {
                                ...
                                jsNV.domMgmt.removeChildren(jsNV.$('clrSwatch'));
                                jsNV.domMgmt.removeCurentNode(jsNV.$('clrSwatch'));
                            }
            ...
            container.style.top = jsNV.objPos.returnObjTop(esrc.gete()) + jsNV.objPos.returnObjHeight(esrc.gete()) + 'px';
            container.style.left = jsNV.objPos.returnObjLeft(esrc.gete()) + 'px';
            jsNV.addEvent(window, 'resize', function (W3CEvent) {
                container.style.top = jsNV.objPos.returnObjTop(esrc.gete()) + jsNV.objPos.returnObjHeight(esrc.gete()) + 'px';
                container.style.left = jsNV.objPos.returnObjLeft(esrc.gete()) + 'px';
            });
    ...
    if (!window.jsNV) { window['jsNV'] = {};}
    window['jsNV']['colorSwatch'] = new colorSwatch();
    ...
    if (!window.jsNV) { window['jsNV'] = {}; }
    window['jsNV']['newWindow'] = new newWindow();
})();
var targetAcc={};
jsNV.addEvent(window, 'load', function (W3CEvent) {
    jsNV.Accessor(targetAcc, 'Targ', function (x) { return typeof x == 'object' });
    var cp = jsNV.$('colorPlt');
    var tar = null;
    var t = jsNV.getElementsByClassName('clrSelector_cls', 'input');
    for (var i = 0; i < t.length; i++) {
        targetAcc.setTarg(jsNV.$(t[i]));
    }
    jsNV.addEvent(cp, 'click', function (W3CEvent) {
        if (jsNV.$('clrSwatch')) {
            jsNV.domMgmt.removeChildren(jsNV.$('clrSwatch'));
            jsNV.domMgmt.removeCurentNode(jsNV.$('clrSwatch'));
        }
        else {
            jsNV.colorSwatch.colorPalette(targetAcc.getTarg());
        }
    });
});