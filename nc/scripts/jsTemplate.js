(function () {
    ...
    window['js--']['isCompatible'] = isCompatible;

    function isArray(myArray) {
        return myArray.constructor.toString().indexOf('Array') > 1;
    }
    window['js--']['isArray'] = isArray;
    ...
    window['js--']['preventDefault'] = preventDefault;
    ...
    window['js--']['stopPropagation'] = stopPropagation;
    ...
    window['js--']['getEventObject'] = getEventObject;
    ...
    window['js--']['addLoadEvent'] = addLoadEvent;
    ...
    window['js--']['removeEvent'] = removeEvent;
    ...
    window['js--']['getElementsByClassName'] = getElementsByClassName;
    ...
    window['js--']['toggleDisplay'] = toggleDisplay;
    ...
    window['js--']['insertAfter'] = insertAfter;
    ...
    function domMgmt() {
        ...
        this.removeCurentNode = function (elem) {
            var elem2Remove = (!js--.$(elem)) ? elem : js--.$(elem);
            if (elem2Remove != null
    ...
    window['js--']['prependChild'] = prependChild;

    function objPos() {
        this.setObjPos = function (obj, relativeObj) {
            var f = js--.DomOopObjects.$(relativeObj);
            var x = 0;
            var y = 0;
            while (f) {
                x += f.offsetLeft;
    ...
    window['js--']['getBrowserWindowSize'] = new getBrowserWindowSize();
    ...
    window['js--']['getPointerPositionInDocument'] = getPointerPositionInDocument;
    ...
    window['js--']['getMyBoundingClientRect'] = getMyBoundingClientRect;
    ...
    window['js--']['getKeyPressed'] = getKeyPressed;
    ...
    window['js--']['setStyle'] = setStyleById;
    window['js--']['setStyleById'] = setStyleById;
    ...
    window['js--']['setStylesByClassName'] = setStylesByClassName;
    ...
    window['js--']['setStylesByTagName'] = setStylesByTagName;
    ...
    window['js--']['getWindowSize'] = getWindowSize;

    // Canvas functions will now follow:
    function degree2rad(degree) {
        return Math.PI * degree / 180;
    };
    window['js--']['degree2rad'] = new degree2rad();
    ...
    window['js--']['xmlRequest'] = new xmlRequest();
    ...
    function colorSwatch(eventSrc) {
        ...
        this.colorPalette = function (target, selection) {
            ...
            js--.Accessor(esrc, 'e', function (x) { return typeof x == 'object'; });
            esrc.sete(t);
            ...
            for (var i = 0; i < Spectrum.length; i++) {
                for (var j = 0; j < Spectrum.length; j++) {
                    ...
                    for (var k = 0; k < Spectrum.length; k++) {
                        ...
                        js--.addEvent(ccell, 'mouseover', function (W3CEvent) {
                            var e = event.srcElement;
                            var target = js--.$('clrIO');
                            target.value = e.style.backgroundColor;
                            td1.style.backgroundColor = e.style.backgroundColor;
                        })
                        js--.addEvent(ccell, 'mouseout', function (W3CEvent) {
                            var target = js--.$('clrIO');
                            target.value = '';
                            td1.style.backgroundColor = '';
                        });
                        js--.addEvent(ccell, 'click', function (W3CEvent) {
                            var e1 = event.srcElement;
                            js--.preventDefault(ccell);
                            js--.stopPropagation(ccell);
                            ...
                            if (esrc.gete().nodeName === 'INPUT') {
                                ...
                                js--.domMgmt.removeChildren(js--.$('clrSwatch'));
                                js--.domMgmt.removeCurentNode(js--.$('clrSwatch'));
                            }
            ...
            container.style.top = js--.objPos.returnObjTop(esrc.gete()) + js--.objPos.returnObjHeight(esrc.gete()) + 'px';
            container.style.left = js--.objPos.returnObjLeft(esrc.gete()) + 'px';
            js--.addEvent(window, 'resize', function (W3CEvent) {
                container.style.top = js--.objPos.returnObjTop(esrc.gete()) + js--.objPos.returnObjHeight(esrc.gete()) + 'px';
                container.style.left = js--.objPos.returnObjLeft(esrc.gete()) + 'px';
            });
    ...
    if (!window.js--) { window['js--'] = {}; }
    window['js--']['colorSwatch'] = new colorSwatch();
    ...
    if (!window.js--) { window['js--'] = {}; }
    window['js--']['newWindow'] = new newWindow();
})();