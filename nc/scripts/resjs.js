(function () {
    ...
    window['jsRes']['isCompatible'] = isCompatible;

    function isArray(myArray) {
        return myArray.constructor.toString().indexOf('Array') > 1;
    }
    window['jsRes']['isArray'] = isArray;
    ...
    window['jsRes']['preventDefault'] = preventDefault;
    ...
    window['jsRes']['stopPropagation'] = stopPropagation;
    ...
    window['jsRes']['addLoadEvent'] = addLoadEvent;
    ...
    window['jsRes']['addEvent'] = addEvent;
    ...
    window['jsRes']['Accessor'] = Accessor;
    ...
    window['jsRes']['camelize'] = camelize;
    ...
    window['jsRes']['getEventObject'] = getEventObject;
    ...
    window['jsRes']['removeEvent'] = removeEvent;
    ...
    window['jsRes']['getElementsByClassName'] = getElementsByClassName;
    ...
    window['jsRes']['toggleDisplay'] = toggleDisplay;
    ...
    window['jsRes']['insertAfter'] = insertAfter;
    ...
    function domMgmt() {
        ...
        this.removeCurentNode = function (elem) {
            var elem2Remove = (!jsRes.$(elem)) ? elem : jsRes.$(elem);
            if (elem2Remove != null
    ...
    window['jsRes']['domMgmt'] = new domMgmt();
    ...
    window['jsRes']['prependChild'] = prependChild;

    function objPos() {
        this.setObjPos = function (obj, relativeObj) {
            var f = jsRes.DomOopObjects.$(relativeObj);
            var x = 0;
            var y = 0;
            while (f) {
                x += f.offsetLeft;
    ...
    window['jsRes']['objPos'] = new objPos();
    ...
    window['jsRes']['getBrowserWindowSize'] = new getBrowserWindowSize();
    ...
    window['jsRes']['getPointerPositionInDocument'] = getPointerPositionInDocument;
    ...
    window['jsRes']['getMyBoundingClientRect'] = getMyBoundingClientRect;
    ...
    window['jsRes']['getKeyPressed'] = getKeyPressed;
    ...
    window['jsRes']['setStyle'] = setStyleById;
    window['jsRes']['setStyleById'] = setStyleById;
    ...
    window['jsRes']['setStylesByClassName'] = setStylesByClassName;
    ...
    window['jsRes']['setStylesByTagName'] = setStylesByTagName;
    ...
    window['jsRes']['getWindowSize'] = getWindowSize;

    // Canvas functions will now follow:
    function degree2rad(degree) {
        return Math.PI * degree / 180;
    };
    window['jsRes']['degree2rad'] = new degree2rad();
    ...
    window['jsRes']['xmlRequest'] = new xmlRequest();
    ...
    function colorSwatch(eventSrc) {
        ...
        this.colorPalette = function (target, selection) {
            ...
            jsRes.Accessor(esrc, 'e', function (x) { return typeof x == 'object'; });
            esrc.sete(t);
            ...
            for (var i = 0; i < Spectrum.length; i++) {
                for (var j = 0; j < Spectrum.length; j++) {
                    ...
                    for (var k = 0; k < Spectrum.length; k++) {
                        ...
                        jsRes.addEvent(ccell, 'mouseover', function (W3CEvent) {
                            var e = event.srcElement;
                            var target = jsRes.$('clrIO');
                            target.value = e.style.backgroundColor;
                            td1.style.backgroundColor = e.style.backgroundColor;
                        })
                        jsRes.addEvent(ccell, 'mouseout', function (W3CEvent) {
                            var target = jsRes.$('clrIO');
                            target.value = '';
                            td1.style.backgroundColor = '';
                        });
                        jsRes.addEvent(ccell, 'click', function (W3CEvent) {
                            var e1 = event.srcElement;
                            jsRes.preventDefault(ccell);
                            jsRes.stopPropagation(ccell);
                            ...
                            if (esrc.gete().nodeName === 'INPUT') {
                                ...
                                jsRes.domMgmt.removeChildren(jsRes.$('clrSwatch'));
                                jsRes.domMgmt.removeCurentNode(jsRes.$('clrSwatch'));
                            }
            ...
            container.style.top = jsRes.objPos.returnObjTop(esrc.gete()) + jsRes.objPos.returnObjHeight(esrc.gete()) + 'px';
            container.style.left = jsRes.objPos.returnObjLeft(esrc.gete()) + 'px';
            jsRes.addEvent(window, 'resize', function (W3CEvent) {
                container.style.top = jsRes.objPos.returnObjTop(esrc.gete()) + jsRes.objPos.returnObjHeight(esrc.gete()) + 'px';
                container.style.left = jsRes.objPos.returnObjLeft(esrc.gete()) + 'px';
            });
    ...
    if (!window.jsRes) { window['jsRes'] = {}; }
    window['jsRes']['colorSwatch'] = new colorSwatch();
    ...
    if (!window.jsRes) { window['jsRes'] = {}; }
    window['jsRes']['newWindow'] = new newWindow();
    ...
    window['jsRes']['asyncImport'] = new asyncImport();
})();
var _tb = null, _err = null;
jsRes.addEvent(window, 'load', function (W3CEvent) {
    _tb = jsRes.getElementsByClassName('tb_class', 'INPUT');
    _err = jsRes.$('errMsg');

    _tb[1].Compare2 = _tb[0];
    _tb[1].msg = _err;
    jsRes.addEvent(_tb[1], 'change', function (W3CEvent) {
        var e=event.srcElement;
        if (this.Compare2.value != _tb[1].value) {
            this.Compare2.value = '';
            _tb[1].value = '';
