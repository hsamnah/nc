(function () {
    ...
    window['jsVPS']['isCompatible'] = isCompatible;

    function isArray(myArray) {
        return myArray.constructor.toString().indexOf('Array') > 1;
    }
    window['jsVPS']['isArray'] = isArray;
    ...
    window['jsVPS']['preventDefault'] = preventDefault;
    ...
    window['jsVPS']['stopPropagation'] = stopPropagation;
    ...
    window['jsVPS']['addLoadEvent'] = addLoadEvent;
    ...
    window['jsVPS']['addEvent'] = addEvent;
    ...
    window['jsVPS']['Accessor'] = Accessor;
    ...
    window['jsVPS']['camelize'] = camelize;
    ...
    window['jsVPS']['getEventObject'] = getEventObject;
    ...
    window['jsVPS']['removeEvent'] = removeEvent;
    ...
    window['jsVPS']['getElementsByClassName'] = getElementsByClassName;
    ...
    window['jsVPS']['toggleDisplay'] = toggleDisplay;
    ...
    window['jsVPS']['insertAfter'] = insertAfter;
    ...
    function domMgmt() {
        ...
        this.removeCurentNode = function (elem) {
            var elem2Remove = (!jsVPS.$(elem)) ? elem : jsVPS.$(elem);
            if (elem2Remove != null
    ...
    window['jsVPS']['domMgmt'] = new domMgmt();
    ...
    window['jsVPS']['prependChild'] = prependChild;

    function objPos() {
        this.setObjPos = function (obj, relativeObj) {
            var f = jsVPS.DomOopObjects.$(relativeObj);
            var x = 0;
            var y = 0;
            while (f) {
                x += f.offsetLeft;
    ...
    window['jsVPS']['objPos'] = new objPos();
    ...
    window['jsVPS']['getBrowserWindowSize'] = new getBrowserWindowSize();
    ...
    window['jsVPS']['getPointerPositionInDocument'] = getPointerPositionInDocument;
    ...
    window['jsVPS']['getMyBoundingClientRect'] = getMyBoundingClientRect;
    ...
    window['jsVPS']['getKeyPressed'] = getKeyPressed;
    ...
    window['jsVPS']['setStyle'] = setStyleById;
    window['jsVPS']['setStyleById'] = setStyleById;
    ...
    window['jsVPS']['setStylesByClassName'] = setStylesByClassName;
    ...
    window['jsVPS']['setStylesByTagName'] = setStylesByTagName;
    ...
    window['jsVPS']['getWindowSize'] = getWindowSize;

    // Canvas functions will now follow:
    function degree2rad(degree) {
        return Math.PI * degree / 180;
    };
    window['jsVPS']['degree2rad'] = new degree2rad();
    ...
    window['jsVPS']['xmlRequest'] = new xmlRequest();
    ...
    function colorSwatch(eventSrc) {
        ...
        this.colorPalette = function (target, selection) {
            ...
            jsVPS.Accessor(esrc, 'e', function (x) { return typeof x == 'object'; });
            esrc.sete(t);
            ...
            for (var i = 0; i < Spectrum.length; i++) {
                for (var j = 0; j < Spectrum.length; j++) {
                    ...
                    for (var k = 0; k < Spectrum.length; k++) {
                        ...
                        jsVPS.addEvent(ccell, 'mouseover', function (W3CEvent) {
                            var e = event.srcElement;
                            var target = jsVPS.$('clrIO');
                            target.value = e.style.backgroundColor;
                            td1.style.backgroundColor = e.style.backgroundColor;
                        })
                        jsVPS.addEvent(ccell, 'mouseout', function (W3CEvent) {
                            var target = jsVPS.$('clrIO');
                            target.value = '';
                            td1.style.backgroundColor = '';
                        });
                        jsVPS.addEvent(ccell, 'click', function (W3CEvent) {
                            var e1 = event.srcElement;
                            jsVPS.preventDefault(ccell);
                            jsVPS.stopPropagation(ccell);
                            ...
                            if (esrc.gete().nodeName === 'INPUT') {
                                ...
                                jsVPS.domMgmt.removeChildren(jsVPS.$('clrSwatch'));
                                jsVPS.domMgmt.removeCurentNode(jsVPS.$('clrSwatch'));
                            }
            ...
            container.style.top = jsVPS.objPos.returnObjTop(esrc.gete()) + jsVPS.objPos.returnObjHeight(esrc.gete()) + 'px';
            container.style.left = jsVPS.objPos.returnObjLeft(esrc.gete()) + 'px';
            jsVPS.addEvent(window, 'resize', function (W3CEvent) {
                container.style.top = jsVPS.objPos.returnObjTop(esrc.gete()) + jsVPS.objPos.returnObjHeight(esrc.gete()) + 'px';
                container.style.left = jsVPS.objPos.returnObjLeft(esrc.gete()) + 'px';
            });
    ...
    if (!window.jsVPS) { window['jsVPS'] = {}; }
    window['jsVPS']['colorSwatch'] = new colorSwatch();
    ...
    if (!window.jsVPS) { window['jsVPS'] = {}; }
    window['jsVPS']['newWindow'] = new newWindow();
    ...
    window['jsVPS']['asyncImport'] = new asyncImport();
})();